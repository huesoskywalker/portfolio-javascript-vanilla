...
class AboutLife extends HTMLElement {
    ...
    disconnectedCallback() {
        const codeAnimation = this.shadowRoot.querySelector(".codeAnim").pause()

        const treeAnimation = this.shadowRoot.querySelector(".treeAnim").pause()

        const beerAnimation = this.shadowRoot.querySelector(".beerAnim").pause()

        const designAnimation = this.shadowRoot.querySelector(".designAnim").pause()

        const travelAnimation = this.shadowRoot.querySelector(".travelAnim").pause()
    }
}
